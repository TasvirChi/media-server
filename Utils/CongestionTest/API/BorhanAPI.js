...
var logger = LoggerEx("BorhanAPI");
function BorhanAPI() {

    this._connectionInfo=config.BorhanService;
...
BorhanAPI.prototype.call=function(params) {
    var _this=this;
    var now=new Date();
...
BorhanAPI.prototype.login = function () {
...
BorhanAPI.prototype._kcall=function(params,ingoreMR) {
    ...
    var serverIndex = params.serverIndex || 0;
     ...
     return $q.Promise(function (resolve, reject) {
            ...
            request.post({
                ...
                if (result && result.objectType === "BorhanAPIException") {
...
BorhanAPI.prototype.startMultirequest=function () {
    this._multiRequestPromises=[];
    this._multiRequestParams = { service: "multirequest", action: null };
}

BorhanAPI.prototype.execMultirequest=function() {
...
var borhanAPI=new BorhanAPI();
module.exports.BorhanAPI=borhanAPI;
