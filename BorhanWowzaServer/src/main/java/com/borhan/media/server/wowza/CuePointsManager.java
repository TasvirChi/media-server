...
public class CuePointsManager  extends ModuleBase  {
	...
	private static final String OBJECT_TYPE_VALUE = "BorhanSyncPoint";
	...
	private final static String BORHAN_SYNC_POINTS_INTERVAL_PROPERTY = "BorhanSyncPointsInterval";
	...
	public void onAppStart(IApplicationInstance applicationInstance) {
		...
		syncPointsInterval = applicationInstance.getProperties().getPropertyInt(BORHAN_SYNC_POINTS_INTERVAL_PROPERTY, DEFAULT_SYNC_POINTS_INTERVAL_IN_MS);
